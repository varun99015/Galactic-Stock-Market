  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-red-400 font-mono p-8 flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="text-sm text-red-300">{error || 'No stock data available'}</div>
        <button 
...
{/* Section 2: Full-Width Chart and Trading Form */}
        <div className="relative z-10 grid grid-cols-1 lg:grid-cols-1 gap-6 md:gap-10 mb-10">
          ...
          {/* Chart takes up 2/3 of the space on large screens */}
          <div className="lg:col-span-2 border border-cyan-500 p-4 md:p-6 rounded-2xl shadow-lg bg-opacity-10 bg-cyan-900 backdrop-blur-sm">
