        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mb-10">
          ...
          <div className="space-y-4 border border-cyan-500 p-4 md:p-6 rounded-2xl shadow-lg bg-opacity-10 bg-cyan-900 backdrop-blur-sm">
            ...
            <div className="mt-4 pt-4 border-t border-cyan-800">
                ...
                {(() => {
                  ...
                  return (
                    <>
                      ...
                      {stock.techSpecs && (
                        <> <h1 className='mt-4 pt-2 mb-4 text-cyan-500 border-t border-cyan-700'>Tech Specs</h1>
                      ...
                      {stock.us && (
                        <><h1 className='mt-4 pt-2 mb-4 text-cyan-500 border-t border-cyan-700'>Market Data</h1>
              ...
              <h3 className="mt-4 pt-4 border-t border-cyan-800 text-cyan-400 mb-2 text-sm md:text-base">MINING TAXONOMY</h3>
