        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mb-8 md:mb-10">
          ...
          <div className="space-y-4 border border-cyan-500 p-4 md:p-6 rounded-xl md:rounded-2xl shadow-lg bg-opacity-10 bg-cyan-900 backdrop-blur-sm">
            ...
            <div className="mt-4 pt-4 border-t border-cyan-800">
                  ...
                  if (stock.externalData) {
                    return (
                      <>
                        ...
                        <p>Constellation : {stock.externalData.cons}</p>
                        <p>Coverage : {stock.externalData.coverage}</p>
                      </>
                    );
                    ...
                    return (
                      <>
                        ...
                        <p>Latency : {stock.fictionalData.latency}</p>
                        <p>Bandwidth : {stock.fictionalData.bandwidth}</p>
                        <p>Clients : {stock.fictionalData.clients}</p>
                      </>
                    );
                  }
                })()}
              ...
              <h3 className="mt-4 pt-4 border-t border-cyan-800 text-cyan-400 mb-2 text-sm md:text-base">COMMUNICATIONS SECTORS</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 md:p-6">
                {commsSectors.map((sector, index) => (
                  <div
                    key={index}
